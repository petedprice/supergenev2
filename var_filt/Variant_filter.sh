...
#$ -wd /fastdata/bop20pp/supergene_AB_maleref/wasp_genotyped_vcfs/wdir

source /usr/local/extras/Genomics/.bashrc

out=${1%".genotyped.vcf.gz"}
file=${out#"/fastdata/bop20pp/supergene_AB_maleref/wasp_genotyped_vcfs/"}
...
vcftools --vcf $out.tempclus.filt.ba.vcf --out /fastdata/bop20pp/supergene_AB_maleref/post_wasp_filtered_genotyped_vcfs/${file}_filtered --minGQ 30 --minDP 10 --recode --recode-INFO-all
