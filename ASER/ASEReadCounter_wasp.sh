...
java -Dsamjdk.use_async_io_read_samtools=false -Dsamjdk.use_async_io_write_samtools=true \
	...
	-I /fastdata/bop20pp/supergene_AB_maleref/output_0610_standard_wasp/bam/${1}_tgu_Sample_${2}_md_cig.RG.bam \
	-V /fastdata/bop20pp/supergene_AB_maleref/output_0610_standard_wasp/filtered_genotyped_vcfs/${1}_tgu_Sample_${2}_filtered.recode.vcf.gz \
