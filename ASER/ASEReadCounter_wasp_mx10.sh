...
#$ -wd /fastdata/bop20pp/supergene_AB_maleref/ASER_mx10_wasp/wdir
...
java -Dsamjdk.use_async_io_read_samtools=false -Dsamjdk.use_async_io_write_samtools=true \
	...
	-I /fastdata/bop20pp/supergene_AB_maleref/output_0810_mx10_wasp/bam/${1}_tgu_Sample_${2}_md_cig.RG.bam \
	-V /fastdata/bop20pp/supergene_AB_maleref/output_0810_mx10_wasp/filtered_genotyped_vcfs/${1}_tgu_Sample_${2}_filtered.recode.vcf.gz \
	-O /fastdata/bop20pp/supergene_AB_maleref/ASER_mx10_wasp/counts/${1}_${2}.ASER.counts
