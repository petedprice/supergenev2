...
rm /fastdata/bop20pp/supergene_wogtf/relatedness/Zmerged_vcfs.list

for s in /fastdata/bop20pp/supergene_wogtf/gvcfs/CM020861.1*vcf.gz
do
out=${s#"/fastdata/bop20pp/supergene_wogtf/gvcfs/"}
out2=${out%".vcf.gz"}
echo $out2
...
echo /fastdata/bop20pp/supergene_wogtf/relatedness/${out2}.rh.vcf.gz >> /fastdata/bop20pp/supergene_wogtf/relatedness/Zmerged_vcfs.list
...
java -Dsamjdk.use_async_io_read_samtools=false -Dsamjdk.use_async_io_write_samtools=true \
	...
	--variant /fastdata/bop20pp/supergene_wogtf/relatedness/Zmerged_vcfs.list \
	-O /fastdata/bop20pp/supergene_wogtf/relatedness/TGU_Z_combine.g.vcf.gz \
