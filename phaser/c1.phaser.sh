...
bgzip -f /fastdata/bop20pp/supergene_AB_maleref/filtered_genotyped_vcfs/${1}_tgu_Sample_${2}_filtered.recode.vcf
tabix -f -p vcf /fastdata/bop20pp/supergene_AB_maleref/filtered_genotyped_vcfs/${1}_tgu_Sample_${2}_filtered.recode.vcf.gz
